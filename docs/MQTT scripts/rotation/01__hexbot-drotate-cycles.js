...
// (starting even legs at end of 12 degree range like this makes the flow sequence repeatable to be able to do more than 12 degrees)
	send("fl,050,1,10,0,0,0, 18.62,-14.79,-10.60, -4.31,-20.26,-9.60,-18.62,-14.79,-10.60,21.29,10.60,-9.60,0.00,20.72,-10.60,-15.14,18.34,-9.60")
...
// at the same time, move even numbered legs (up in the air) 4 degrees CCW, on the way back to their home position
	send("fl,200,1,10,0,0,0, 17.54,-16.05,-10.60, -2.88,-20.51,-9.60, -19.61,-13.46,-10.60, 20.50,12.06,-9.60, 1.45,20.67,-10.60, -16.38,17.24,-9.60")
// do another 4 degrees, for both odd and even legs, as above
	send("fl,200,1,10,0,0,0, 16.38,-17.24,-10.60, -1.44,-20.66,-9.60, -20.50,-12.06,-10.60, 19.61,13.46,-9.60, 2.88,20.52,-10.60, -17.54,16.05,-9.60")
...
// after this, the odd legs are 12 degrees CW from home, and even legs are back to home position
	send("fl,200,1,10,0,0,0, 15.14,-18.34,-10.60,  0.00,-20.71,-9.60, -21.29,-10.60,-10.60, 18.62,14.79,-9.60, 4.31,20.27,-10.60, -18.62,14.79,-9.60")
...
// get the even legs on the ground before you raise the odds, or the bot dips down inbetween
	send("fl,050,1,10,0,0,0, 15.14,-18.34,-10.60,  0.00,-20.71,-10.60, -21.29,-10.60,-10.60, 18.62,14.79,-10.60, 4.31,20.27,-10.60, -18.62,14.79,-10.60")
	send("fl,050,1,10,0,0,0, 15.14,-18.34,-9.60,   0.00,-20.71,-10.60, -21.29,-10.60,-9.60, 18.62,14.79,-10.60, 4.31,20.27,-9.60, -18.62,14.79,-10.60")
...
// at the same time, move odd legs (up in the air) 4 degrees CCW, on the way back to their home position
	send("fl,200,1,10,0,0,0, 16.38,-17.24,-9.60,  -1.44,-20.66,-10.60, -20.50,-12.06,-9.60, 19.61,13.46,-10.60, 2.88,20.52,-9.60, -17.54,16.05,-10.60")
	// do another 4 degrees, for both odd and even legs, as above
	send("fl,200,1,10,0,0,0, 17.54,-16.05,-9.60,  -2.88,-20.51,-10.60, -19.61,-13.46,-9.60, 20.50,12.06,-10.60, 1.45,20.67,-9.60, -16.38,17.24,-10.60")
// and do it one more time, so we've moved a total of 12 degrees.
// at this point, even legs are 12 degrees CW from home, and odd legs are back to home position	
	send("fl,200,1,10,0,0,0, 18.62,-14.79,-9.60,  -4.31,-20.26,-10.60, -18.62,-14.79,-9.60, 21.29,10.60,-10.60, 0.00,20.72,-9.60, -15.14,18.34,-10.60")
// get all the legs on the ground before you lift different ones, to a void a dip inbetween	
	send("fl,050,1,10,0,0,0, 18.62,-14.79,-10.60,  -4.31,-20.26,-10.60, -18.62,-14.79,-10.60, 21.29,10.60,-10.60, 0.00,20.72,-10.60, -15.14,18.34,-10.60")
...
*/
	...
	send("do_flow,1,50")          // start er up, 50 msec/frame (== 20 frames/sec), move toes and don't print coords for each frame
